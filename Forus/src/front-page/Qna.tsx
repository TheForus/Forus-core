...
const Qna = (props: Props) => {
  ...
  return (
    <div
      id="faq"
      className="p-5 py-10 flex flex-col items-center justify-center bg-[#cdd4dc] "
    >
      <h1 className="montserrat-subheading text-4xl mb-6 text-[#131619]  pb-2 ">
        FAQ
      </h1>
      <div
        className="xl:p-14 xl:px-20 bg-[#cdd4dc] transition-all ease-linear md:w-[790px] lg:w-[900px] p-5 rounded-md
      ...
      >
        ...
        >
          1: How does forus ensure the privacy and confidentiality of
        ...
        {showAnswers[2] && (
          <p className=" w-[90%] px-4  pb-5  montserrat-subheading text-[#58707e] text-left">
            Simply click the "generate" button , and a unique Forus key will be generated for you. Make sure to save the
            accompanying signature  key in a secure location for future use.
          </p>
        )}
        <h4
        ...
        lg:text-lg cursor-pointer flex items-center
         montserrat-subheading py-4 text-gray-600 gap-16`}
        >
          4: Can I retrieve my private key after funds have been sent to my Forus key?
          <span>
            {showAnswers[3] ? (
              <IoAddSharp
                color="#131619"
        ...
        {showAnswers[4] && (
          <p className="dark:text-gray-300 w-[90%] px-4  pb-5  montserrat-subheading text-[#58707e] text-left">
            Absolutely! forus has been designed with a user-friendly
