  ...
  return (
    <>
      ...
      <div className="flex justify-center pt-2 mr-4">
        <div
          className="flex ml-1  items-center cursor-pointer space-x-1 border-1 p-1 hover:bg-gray-900 hover:border-none  text-white bg-[#1f2429] hover:shadow-xl px-4 text-center rounded-md  font-semibold hover:border-white border-[#181b1f] border"
