...
const Forus = (props: Props) => {
  ...
  return (
    <AppContext.Provider value={ContextValue}>
      <div className="bg-gradient-to-tr from-black via-black/80 bg-[#1A1B1D] to-transparent relative w-full h-full">
        <div
        ...
        <div className="bg-black/80 max-h-max min-h-[100vh] lg:overflow-hidden">
          ...
          <div
            ...
            py-8 p-4"
          >
            <div className="relative lg:ml-11 xl:w-[90%] w-[100%] h-full shadow-2xl shadow-gray-800">
              <div
                className="border border-gray-600 shadow-black absolute top-0 right-0
               w-full h-full rounded-md bg-gradient-to-tl from-cyan-800 to-cyan-400"
              ></div>
              <Foruskey />
            </div>
            <div
