    ...
    <>
      ...
      >
        ...
        <div className="flex flex-col items-start space-y-6 mt-12">
          <h2
            className="dark:text-[#10F1B4] montserrat-subtitle font-bold sm:text-[2.0rem]
          text-left text-[2.4rem] text-[white]"
          >
            Stay anonymous & secure
          </h2>
          <p className="montserrat-small font-semibold text-[#58707e] dark:text-gray-400 text-left break-words  max-w-[400px] text-[1.1rem]">
