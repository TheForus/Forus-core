...
const Features = (props: Props) => {
  return (
    <div className="sm:px-20 px-12 p-4 flex flex-col py-24 space-y-10 justify-center items-center">
      <h1 className="montserrat-subtitle font-extrabold py-4 text-4xl  text-sectionheader  border-b border-gray-400">
      ...
      >
        ...
        >
          <MdPrivacyTip color="#9ff3ff" className="text-[60px]" />
        </FeatureBlock>
        <FeatureBlock
        ...
        >
          <MdHandshake color="#9ff3ff" className="text-[60px]" />
        </FeatureBlock>
        <FeatureBlock
          heading="Secure Fund Transfer"
          subheading="Cryptia enables users to transfer funds securely and confidentially using its state-of-the-art system. Through the utilization of stealth or secret addresses, the sender and recipient can conduct transactions without revealing their identities or sensitive financial details. The sender generates a corresponding stealth address based on the recipient's unique CP address, ensuring that the funds are received securely and privately. Additionally, Cryptia employs robust encryption algorithms and stringent security protocols, further bolstering the safety of fund transfers.."
        >
          <AiOutlineTransaction color="#9ff3ff" className="text-[60px]" />
        </FeatureBlock>
        <FeatureBlock
        ...
        >
          <MdNewReleases color="#9ff3ff" className="text-[60px]" />
        </FeatureBlock>
      </div>
    </div>
  );
