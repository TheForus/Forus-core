            ...
            <div className="sm:px-7 px-4 flex justify-between">
                ...
                <div className='flex items-center cursor-pointer' onClick={() => navigate('/')}>
                    <div className='flex space-x-1 items-center'>
                        ...
                        />
                        <h1 className='montserrat-subtitle sm:text-[1.3rem] font-semibold text-[1.1rem] text-[#6c8492]'>Cryptia</h1>
                    </div>
                ...
                <div className="sm:flex-row flex-co flex space-x-3 items-center">
                    <p className='text-[#91acbb]'><a href="/https://discord.gg/qupF3BrP"><FaDiscord size={20} /></a></p>
                    <p className='text-[#91acbb]'><a href="https://github.com/ScriptKiddii/Cloak"><FaGithub size={20} /></a></p>
                    <p className='text-[#91acbb]'><a href="https://twitter.com/TronCloak"><FaTwitter size={20} /></a></p>
